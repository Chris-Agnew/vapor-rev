...
const Navbar = () => {
  return (
    <div className="flex flex-col items-center justify-center w-screen h-full bg-black md:flex-row ">
      ...
      <div className="flex items-center justify-center w-full mt-5 mb-5 mr-2 text-4xl text-center bg-black space-around text-light-blue ">
      ...
      <div className="items-center hidden md:justify-center text-light-blue md:flex ">
        <Link href="#services">
