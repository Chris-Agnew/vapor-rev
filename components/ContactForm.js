  ...
  return (
   ...
   <form onSubmit={handleSubmit}>
      <div className="flex items-center justify-center m-5">
        ...
        <input type="text" id="name" placeholder="John Smith" className="p-2 ml-5 bg-gray-300 rounded-full outline-none" required />
      </div>
      <div className="flex items-center justify-center m-5">
        <label htmlFor="email" className="text-xl text-gray-200">Email:</label>
        <input type="email" id="email" placeholder="john@smith.com" className="p-2 ml-5 text-left bg-gray-300 rounded-full outline-none radius" required />
      </div>
      <div className="flex items-center justify-center p-5">
        <div><label htmlFor="message" className="text-xl text-gray-200">Message:</label></div>
        <textarea placeholder="Type your message here" id="message" required className="p-2 mt-5 ml-5 bg-gray-300 border-2 rounded outline-none h-28"/>
      </div>
